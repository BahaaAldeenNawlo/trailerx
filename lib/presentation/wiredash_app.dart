  ...
  Widget build(BuildContext context) {
    ...
    return Wiredash(
      ...
      theme: WiredashThemeData(
        ...
        primaryContainerColor: isDarkTheme ? AppColor.vulcan : Colors.white,
        appHandleBackgroundColor: isDarkTheme ? Colors.white : AppColor.vulcan,
        textOnSecondaryContainerColor: isDarkTheme ? Colors.white : AppColor.vulcan,
        firstPenColor: isDarkTheme ? Colors.white : AppColor.vulcan,
      ),
      child: child,
    );
  }
